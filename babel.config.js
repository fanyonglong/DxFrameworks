...
//   }
// }).argv
// const module=argv.module=='false'?false:argv.module;
...
let presets = [
  [
    ...
    例如，@babel/plugin-transform-regenerator如果您不使用生成器并且不想包含regeneratorRuntime（使用时useBuiltIns）或使用其他插件（如fast-async而不是Babel的async-to-gen）。
      ...
      loose:false,//为此预设中允许它们的任何插件启用“松散”转换。
       ...
       */
      useBuiltIns:false,//'entry',// false,//"usage",//"usage"| "entry"| false，默认为false。
